...
const SupplierBillDetails = () => {
  ...
  const { data: supplierData, isLoading: supplierDataLoading, isFetching: supplierDataFetching } = Queries.useGetContactDropdown({ activeFilter: true, typeFilter: "supplier" });
    ...
    <>
      <Grid container spacing={2} sx={{ p: 2 }}>
        <Grid container spacing={2} size={{ xs: 12, md: 3 }}>
          <CommonValidationSelect name="supplierId" label="Select Supplier" required isLoading={supplierDataLoading || supplierDataFetching} options={supplierOptions} grid={{ xs: 12 }} />
