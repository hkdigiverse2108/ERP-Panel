...
const SupplierBillTabs = ({ emptyRow, emptyReturnRow }: SupplierBillTabsProps) => {
  ...
  const handleBulkAdd = async (file: File) => {
    try {
      ...
      const updatedItems = [...(values.productDetails ?? []).filter((i: SupplierBillProductItem) => i.productId), ...mappedItems];
      ...
      <Box sx={{ width: "100%" }}>
        <Box sx={{ borderBottom: 1, borderColor: "divider", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 1, p: 1 }}>
            <CommonButton variant="contained" startIcon={<UploadFile />} title="Upload Products" size="small" disabled={!isSupplierSelected} onClick={() => dispatch(setBulkAddModal({ open: true, title: "Import Supplier Bill", type: BULK_IMPORT_TYPES.SUPPLIER_BILL }))} />
          </Box>
        </Box>
                ...
                {({ push, remove }) => {
                  const ProductRowColumns: CommonTableColumn<any>[] = [
                      ...
                      render: (_, index) => (
                        <>
                          ...
                          {((values?.productDetails || []).length || 0) > 1 && (
                            <CommonButton color="error" variant="outlined" onClick={() => remove && remove(index)}>
                    ...
                    },
                    {
                      ...
                      header: "Qty",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.qty`} type="number" />,
                    ...
                    },
                    {
                      ...
                      header: "Free Qty",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.freeQty`} type="number" />,
                    ...
                    },
                    {
                      ...
                      header: "MRP",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.mrp`} type="number" />,
                    },
                    {
                      key: "unitCost",
                      header: "Unit Cost",
                      bodyClass: "min-w-[120px]",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.unitCost`} type="number" />,
                    },
                    {
                      key: "sellingPrice",
                      header: "Selling Price",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.sellingPrice`} type="number" />,
                    },
                    {
                      key: "discount1",
                      header: "Disc 1",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.discount1`} type="number" />,
                    },
                    {
                      key: "taxableAmount",
                      header: "Taxable",
                ...
                {({ push, remove }) => {
                  const ReturnRowColumns: CommonTableColumn<any>[] = [
                      ...
                      render: (_, index) => (
                        <>
                          {index === ((values?.returnProductDetails?.item || []).length || 0) - 1 && (
                            <CommonButton variant="outlined" onClick={() => push(emptyReturnRow)}>
                              <AddIcon />
                            </CommonButton>
                          )}
                    ...
                    },
                    {
                      ...
                      header: "Qty",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`returnProductDetails.item.${index}.qty`} type="number" />,
                    ...
                    },
                    {
                      ...
                      header: "Unit Cost",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`returnProductDetails.item.${index}.unitCost`} type="number" />,
                    },
                    {
                      key: "discount1",
                      header: "Disc1",
                      bodyClass: "min-w-28",
                      render: (_, index) => <CommonValidationTextField name={`returnProductDetails.item.${index}.discount1`} type="number" />,
                    },
              ...
              <Box className="grid grid-cols-[130px_1fr] border-b border-gray-200 dark:border-gray-700">
                ...
                <Box className="p-1 px-2 flex justify-end">
                  <span className="text-gray-900 dark:text-gray-100 font-bold ml-1 w-50">
                    <CommonValidationTextField name="returnProductDetails.summary.roundOff" label="" type="number" />
                  </span>
                </Box>
              </Box>
