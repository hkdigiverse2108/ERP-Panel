              ...
              {({ push, remove }) => {
                const columns: CommonTableColumn<any>[] = [
                  ...
                  },
                  {
                    ...
                    header: "Landing Cost",
                    bodyClass: "min-w-28",
                    render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.landingCost`} type="number" disabled />,
                  ...
                  },
                  {
                    ...
                    header: "Margin",
                    bodyClass: "min-w-28",
                    render: (_, index) => <CommonValidationTextField name={`productDetails.${index}.margin`} type="number" disabled />,
