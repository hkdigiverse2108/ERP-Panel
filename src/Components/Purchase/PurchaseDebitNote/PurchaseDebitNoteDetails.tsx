...
const PurchaseDebitNoteDetails = () => {
  ...
  const { data: supplierData, isLoading: isSupplierLoading, isFetching: isSupplierFetching } = Queries.useGetContactDropdown({ typeFilter: "supplier" });
  ...
  const { data: purchaseOrderData, isLoading: isPurchaseOrderLoading, isFetching: isPurchaseOrderFetching } = Queries.useGetPurchaseOrderDropdown({ supplierFilter: values?.supplierId });
  ...
  return (
    <Grid container spacing={2} sx={{ p: 2 }}>
      <Grid size={{ xs: 12, md: 3 }} container spacing={2}>
        <CommonValidationSelect name="supplierId" label="Select Supplier" required options={GenerateOptions(suppliers)} isLoading={isSupplierLoading || isSupplierFetching} grid={{ xs: 12 }} />
      ...
      <Grid size={{ xs: 12, md: 9 }} container spacing={2}>
        ...
        <CommonValidationSelect name="purchaseId" label="Select Purchase" options={purchaseOrderOptions} disabled={!values.supplierId} isLoading={isPurchaseOrderLoading || isPurchaseOrderFetching} grid={{ xs: 12, md: 4 }} />
