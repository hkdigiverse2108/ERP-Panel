...
import { CommonButton, CommonPhoneNumber, CommonTextField, CommonValidationDatePicker, CommonValidationSelect } from "../../../../Attribute";
...
const CustomerForm = () => {
  ...
  const initialValues: CustomerFormValues = {
    ...
    country: isCustomerModal.data?.country || "",
              ...
              <Grid container spacing={2}>
                <CommonCard hideDivider grid={{ xs: 12 }}>
                  <Grid container spacing={2} sx={{ p: 2 }}>
                    <CommonTextField name="name" label="Roles Name" required grid={{ xs: 12, md: 4 }} />
                    ...
                    <CommonValidationDatePicker name="dateOfBirth" label="Date Of Birth" required grid={{ xs: 12, md: 4 }} />
                    <CommonValidationDatePicker name="anniversaryDate" label="Anniversary Date" required grid={{ xs: 12, md: 4 }} />
                    <CommonTextField name="email" label="Email" grid={{ xs: 12, md: 4 }} />
                    <CommonTextField name="address" label="Address Line 1" grid={{ xs: 12, md: 4 }} />
                    ...
                    <CommonTextField name="gstin" label="GSTIN" grid={{ xs: 12, md: 4 }} />
                    <Grid size={12} sx={{ display: "flex", gap: 2, ml: "auto" }}>
