...
const PosSidebar = () => {
  ...
  const { data: orderData } = Queries.useGetPosOrder({ lastBillFilter: true });
    ...
    <div className="p-2 space-y-3">
      ...
      <Box className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-dark rounded-md p-3">
        <div className="space-y-2">
          <InfoRow label="Last Bill No." value={lastBill?.orderNo ?? "-"} />
          <InfoRow label="Last Bill Amount" value={`₹${lastBill?.totalAmount ?? 0}`} />
