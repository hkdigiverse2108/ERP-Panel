...
const SalesCreditNoteDetails = () => {
    ...
    const { data: invoiceData, isLoading: isInvoiceLoading, isFetching: isInvoiceFetching } = Queries.useGetInvoiceDropdown({ customerFilter: values?.customerId }, !!values?.customerId);
    ...
    return (
        <Grid container spacing={2} sx={{ p: 2 }}>
            ...
            <Grid size={{ xs: 12, md: 9 }} container spacing={2}>
                ...
                <CommonValidationSelect name="salesId" label="Select Sales" options={invoiceOptions} disabled={!values.customerId} isLoading={isInvoiceLoading || isInvoiceFetching} grid={{ xs: 12, md: 4 }} />
