...
import { GetChangedFields, RemoveEmptyFields, TaxFormSchema } from "../../../../Utils";
...
const TaxForm = () => {
  ...
  return (
    <CommonModal title={PAGE_TITLE.SETTINGS.TAX[pageMode]} isOpen={openModal} onClose={closeModal} className="max-w-125">
