            ...
            <Grid container spacing={2}>
              ...
              <CommonCard title="Basic Details" grid={{ xs: 12 }}>
                <Grid container spacing={2} sx={{ p: 2 }}>
                  ...
                  <CommonTextField name="displayName" label="Display Name" grid={{ xs: 12, md: 4 }} />
                  <CommonTextField name="contactName" label="Contact Name" grid={{ xs: 12, md: 4 }} />
                  <CommonTextField name="phoneNumber" label="Mobile No" grid={{ xs: 12, md: 4 }} />
                  <CommonTextField name="email" label="Email" grid={{ xs: 12, md: 4 }} />
                  <CommonTextField name="ownerNo" label="Owner No" grid={{ xs: 12, md: 4 }} />
                </Grid>
              </CommonCard>
              ...
              <CommonCard title="Communication Details" grid={{ xs: 12 }}>
                <Grid container spacing={2} sx={{ p: 2}}>
                  <CommonTextField name="address" label="Address" grid={{ xs: 12, md: 4 }} multiline/>
              ...
              <CommonCard title="Other Details" grid={{ xs: 12 }}>
                <Grid container spacing={2} sx={{ p: 2 }}>
                  ...
                  <CommonSwitch name="allowRoundOff" label="Allow Round Off" value={values.allowRoundOff} onChange={(checked) => setFieldValue("allowRoundOff", checked)} grid={{ xs: 12, md: 4 }} />
                  <CommonSwitch name="enableFeedbackModule" label="Enable Feedback Module" value={values.enableFeedbackModule} onChange={(checked) => setFieldValue("enableFeedbackModule", checked)} grid={{ xs: 12, md: 4 }} />
                </Grid>
              </CommonCard>
