...
const Invoice_A4Jasper = forwardRef<HTMLDivElement, { bill?: PosOrderBase | any }>(({ bill }, ref) => {
  ...
  return (
    <div ref={ref} className="w-[210mm] mx-auto bg-white text-black p-3 font-serif text-[12px] border">
      ...
      <div className="flex items-center border-b pb-2">
        <img src={logo} className="w-20 h-16 mr-3 object-contain" />
          ...
          {bill?.items?.map((item: any, i: number) => {
            ...
            return (
              <tr key={i}>
                ...
                <td className="border p-1">{item.productId?.brand || "brand name"}</td>
                ...
                <td className="border p-1 text-center">{item.productId?.unit?.name || "UOM code"}</td>
            ...
            <tr>
              ...
              <td className="border p-1">brand name</td>
              <td className="border p-1"></td>
              <td className="border p-1 text-center">10</td>
              <td className="border p-1 text-center">0</td>
              <td className="border p-1 text-center">UOM code</td>
              <td className="border p-1 text-right">2000.00</td>
              <td className="border p-1 text-right">2.00%</td>
              <td className="border p-1 text-right">0.00%</td>
              <td className="border p-1 text-right">19600</td>
              <td className="border p-1 text-center">5%</td>
              <td className="border p-1 text-right">980.00</td>
              <td className="border p-1 text-right">20580.00</td>
            </tr>
          )}
        </tbody>
      </table>
      ...
      <div className="flex justify-between border p-1 font-bold">
        ...
        <span>{Number(bill?.items?.reduce((acc: number, item: any) => acc + (Number(item.netAmount) || 0), 0) || 20638.30).toFixed(2)}</span>
      </div>
          ...
          <tbody>
            {bill?.items?.map((item: any, i: number) => {
              ...
              <tr>
                ...
                <td className="border p-1"></td>
                <td className="border p-1">19600.00</td>
...
export default Invoice_A4Jasper;
