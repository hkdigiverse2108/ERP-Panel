...
const User = () => {
  ...
  return (
    ...
    >
      ...
      >
        <CommonProfileAvatar fullName={user?.fullName} profileImage={user?.profileImage} className="max-xsm:text-sm h-11 w-11 max-xsm:h-9 max-xsm:w-9" />
      </div>
      <div
        className={`fixed lg:absolute max-lg:left-1 max-lg:right-1 lg:right-0 mt-3 flex min-w-[285px] max-w-[330px] flex-col rounded-xl border border-gray-50 bg-white shadow-tooltip dark:border-gray-800 dark:bg-gray-dark z-50 transition-all duration-200 ease-out
        ${open ? "opacity-100 visible scale-100 translate-y-0" : "opacity-0 invisible scale-95 translate-y-2"}`}
      >
        <div className="p-3">
          <div className="flex items-center gap-3">
            <CommonProfileAvatar fullName={user?.fullName} profileImage={user?.profileImage} className="h-11 w-11" />
            <div>
        ...
        <ul className="flex flex-col p-1 pt-0 border-b border-gray-200 dark:border-gray-800">
          <li>
            <Link to={ROUTES.SETTINGS.GENERAL}>
              <div className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
          ...
          <li>
            <Link to={ROUTES.SETTINGS.CHANGE_PASSWORD} className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
              <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to={ROUTES.AUTH.SIGNIN} onClick={() => dispatch(setSignOut())} className="flex items-center gap-3 px-3 py-2 m-2 mx-1 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
