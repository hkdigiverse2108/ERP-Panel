...
export const Queries = {
  ...
  //*************** Company Drive *********
  useGetCompanyDrive: (params?: Params) => useBaseQuery<CompanyDriveApiResponse>([KEYS.COMPANY_DRIVE.BASE, params], URL_KEYS.COMPANY_DRIVE.ALL, params),
};
