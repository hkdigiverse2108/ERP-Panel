...
export const Mutations = {
  ...
  //*************** Company Drive *********
  useAddCompanyDrive: () => useMutations<AddCompanyDrivePayload, void>([KEYS.COMPANY_DRIVE.ADD, KEYS.COMPANY_DRIVE.BASE], (input) => Post(URL_KEYS.COMPANY_DRIVE.ADD, input)),
  useEditCompanyDrive: () => useMutations<EditCompanyDrivePayload, void>([KEYS.COMPANY_DRIVE.EDIT, KEYS.COMPANY_DRIVE.BASE], (input) => Put(URL_KEYS.COMPANY_DRIVE.EDIT, input)),
  useDeleteCompanyDrive: () => useMutations<string, void>([KEYS.COMPANY_DRIVE.DELETE, KEYS.COMPANY_DRIVE.BASE], (id) => Delete(`${URL_KEYS.COMPANY_DRIVE.BASE}/${id}`)),  
};
