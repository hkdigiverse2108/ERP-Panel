...
export const Mutations = {
  ...
  useEditPosOrder: () => useMutations<EditPosProductOrderPayload, PosProductOrderDataResponse>([KEYS.POS.EDIT, KEYS.POS.BASE, KEYS.POS.HOLD_ORDER, KEYS.POS_ORDER.BASE, KEYS.POS_CASH_REGISTER.DETAILS, KEYS.POS_ORDER.DROPDOWN], (input) => Put(URL_KEYS.POS.EDIT, input)),
  useDeletePosOrder: () => useMutations<string, void>([KEYS.POS.DELETE, KEYS.POS.BASE, KEYS.POS.HOLD_ORDER, KEYS.POS_CASH_REGISTER.DETAILS, KEYS.POS_ORDER.DROPDOWN], (id) => Delete(`${URL_KEYS.POS.BASE}/${id}`)),
  ...
  //************ Messenger ********/
  useSaveMessengerConfig: () => useMutations<SaveMessengerConfigPayload, MessengerConfigApiResponse>([KEYS.MESSENGER.CONFIG], (input) => Post(URL_KEYS.MESSENGER.CONFIG, input)),
  useCreateMessengerTemplate: () => useMutations<CreateMessengerTemplatePayload, MessengerTemplateApiResponse>([KEYS.MESSENGER.TEMPLATE], (input) => Post(URL_KEYS.MESSENGER.TEMPLATE, input)),
  useDeleteMessengerTemplate: () => useMutations<{ id: string }, void>([KEYS.MESSENGER.TEMPLATE], (input) => Delete(`${URL_KEYS.MESSENGER.TEMPLATE}/${input.id}`)),
  useRefreshMessengerTemplate: () => useMutations<{ id?: string }, MessengerTemplateApiResponse>([KEYS.MESSENGER.TEMPLATE], (input) => Post(URL_KEYS.MESSENGER.REFRESH_TEMPLATE, input)),
  useSendMessengerMessage: () => useMutations<SendMessengerMessagePayload, void>([KEYS.MESSENGER.LOG], (input) => Post(URL_KEYS.MESSENGER.SEND, input)),

  //************ Meta WhatsApp ********/
  useUpsertMetaWhatsAppAccount: () => useMutations<UpsertMetaWhatsAppAccountPayload, MetaWhatsAppAccountApiResponse>([KEYS.META_WHATSAPP.ACCOUNT], (input) => Post(URL_KEYS.META_WHATSAPP.ACCOUNT_SAVE, input)),
  useCreateMetaWhatsAppTemplate: () => useMutations<CreateMetaTemplatePayload, MetaTemplateApiResponse>([KEYS.META_WHATSAPP.TEMPLATE], (input) => Post(URL_KEYS.META_WHATSAPP.TEMPLATE_CREATE, input)),
  useSyncMetaWhatsAppTemplates: () => useMutations<void, void>([KEYS.META_WHATSAPP.TEMPLATE], (input) => Post(URL_KEYS.META_WHATSAPP.TEMPLATE_SYNC, input)),
  useDeleteMetaWhatsAppTemplate: () => useMutations<string, void>([KEYS.META_WHATSAPP.TEMPLATE, KEYS.META_WHATSAPP.TEMPLATE_DELETE], (id) => Delete(`${URL_KEYS.META_WHATSAPP.TEMPLATE_DELETE}/${id}`)),
  useSendPosBillWhatsApp: () => useMutations<SendPosBillWhatsAppPayload, void>([KEYS.META_WHATSAPP.SEND_POS_BILL, KEYS.META_WHATSAPP.LOGS], (input) => Post(URL_KEYS.META_WHATSAPP.SEND_POS_BILL, input)),
  useBulkSendContactWhatsApp: () =>
    useMutations<BulkSendContactWhatsAppPayload, BulkSendWhatsAppResponse>([KEYS.META_WHATSAPP.SEND_CONTACTS, KEYS.META_WHATSAPP.LOGS], (input) => Post(URL_KEYS.META_WHATSAPP.SEND_CONTACTS, input)),
};
