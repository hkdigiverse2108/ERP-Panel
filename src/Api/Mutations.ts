...
export const Mutations = {
  ...
  useDeletePosOrder: () => useMutations<string, void>([KEYS.POS.DELETE, KEYS.POS.BASE], (id) => Delete(`${URL_KEYS.POS.BASE}/${id}`)),
