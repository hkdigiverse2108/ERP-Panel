...
const initialState: ModalStateSlice = {
  ...
  isCompanyDriveModal: { open: false, data: null },
};
...
const ModalSlice = createSlice({
  ...
  reducers: {
    ...
    setCompanyDriveModal: (state, action) => {
      state.isCompanyDriveModal = action.payload;
    }
  }
});

export const { setOrderRefundModal, setQtyCountModal, setProductDetailsModal, setAdditionalChargeModal, setCashModal, setPayLaterModal, setApplyCouponModal, setUploadModal, setSelectedFiles, clearSelectedFiles, setModalVideoPlay, setCustomerModal, setPaymentListModal, setAddPaymentModal, setRedeemLoyaltyModal, setCreditNoteModal, setOrderModal, setCashControlModal, setRedeemCreditModal, setCardModal, setContactModal, setDiscardModal, setCompanyDriveModal } = ModalSlice.actions;
