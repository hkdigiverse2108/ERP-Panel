...
export interface EstimateBase extends Omit<EstimateFormValues, "customerId" | "termsAndConditionIds" | "additionalCharges" | "billingAddress" | "shippingAddress">, CommonDataType {
  estimateNo: string;
