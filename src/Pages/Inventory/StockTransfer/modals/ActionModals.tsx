                    ...
                    <CommonTable
                      ...
                      columns={[
                        ...
                        { key: "requestedQty", header: "Req Qty", bodyClass: "text-center" },
                        {
                          key: "approvedQty",
                          header: "Approved Qty",
                          render: (_, index) => <CommonValidationTextField name={`items.${index}.approvedQty`} type="number" required />,
                        },
                        {
                          key: "price",
                          header: "Price",
                          render: (_, index) => <CommonValidationTextField name={`items.${index}.price`} type="number" required />,
                        },
                      ]}
...
export const ConfirmReceiptModal = ({ open, onClose, data, onSuccess }: ActionModalProps) => {
  ...
  const columns: CommonTableColumn<any>[] = [
    ...
    { key: "approvedQty", header: "Approved Qty", bodyClass: "text-center" },
    {
      key: "receivedQty",
      header: "Received Qty",
      render: (_, index) => <CommonValidationTextField name={`items.${index}.receivedQty`} type="number" required />,
    },
  ];
