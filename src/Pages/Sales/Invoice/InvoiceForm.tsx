...
const InvoiceForm = () => {
  ...
  const permission = usePagePermission(PAGE_TITLE.SALES.INVOICE.BASE);
  ...
  const handleSubmit = async (values: InvoiceFormValues, { resetForm }: FormikHelpers<InvoiceFormValues>) => {
    ...
    const payload: InvoiceFormValues = {
      ...
      salesOrderIds: selectedSalesOrderId,
      deliveryChallanIds: selectedDeliveryChallanId,
      items: values.items
  ...
  return (
    <>
      <CommonBreadcrumbs title={PAGE_TITLE.SALES.INVOICE[pageMode]} maxItems={3} breadcrumbs={BREADCRUMBS.INVOICE[pageMode]} />
              ...
              <Grid container spacing={2}>
                <Box sx={{ display: "grid", gap: 2, width: "100%" }}>
                  ...
                  <CommonCard hideDivider grid={{ xs: 12 }}>
                    <InvoiceTabs emptyRow={emptyRow} isEditing={isEditing} />
                  </CommonCard>
