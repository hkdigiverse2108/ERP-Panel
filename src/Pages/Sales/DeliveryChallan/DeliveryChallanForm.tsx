...
const DeliveryChallanForm = () => {
  ...
  const permission = usePagePermission(PAGE_TITLE.SALES.DELIVERY_CHALLAN.BASE);
  ...
  return (
    <>
      <CommonBreadcrumbs title={PAGE_TITLE.SALES.DELIVERY_CHALLAN[pageMode]} maxItems={3} breadcrumbs={BREADCRUMBS.DELIVERY_CHALLAN[pageMode]} />
