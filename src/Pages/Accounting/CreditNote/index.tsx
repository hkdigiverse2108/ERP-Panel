...
const CreditNote = () => {
  ...
  const { data: creditNote_data, isLoading: creditNoteDataLoading, isFetching: creditNoteDataFetching } = Queries.useGetCreditNote({ ...params, startDate: range.start.toISOString(), endDate: range.end.toISOString() });
  ...
  const columns: GridColDef<CreditNoteBase>[] = [
    ...
    CommonObjectPropertyColumn<CreditNoteBase>("createdBy", "createdBy", ["fullName", "userType"], { headerName: "Created By", flex: 1, minWidth: 150 , type:"createdBy"}),
